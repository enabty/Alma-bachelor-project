...
def generate_pos_dataset(folder_path):
    ...
    pos_data = [crop_around_middle_50x50_percent(file) for file in pos_data]
    ...
    pos_data = [f(file) for file in pos_data for f in [f1, f2, f3, f4] if file.shape == (400, 400)]
    ...
    print('Done augmenting data. Total number of images: ' + str(len(pos_data)))
