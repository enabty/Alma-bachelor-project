...
"""This is a copy from the ALminer GitHub (https://github.com/emerge-erc/ALminer). 
   The reason to have this copy is to provide for the modified download_data in alminer_mod."""

# Lists and dictionaries for analysis and plotting purposes
band_names = ["Band 3", "Band 4", "Band 5",
              "Band 6", "Band 7", "Band 8, 9, 10"]

band_color = {"Band 3": "#BDD9BF", "Band 4": "#929084", "Band 5": "#FFC857", "Band 6": "#A997DF",
              "Band 7": "#E5323B", "Band 8, 9, 10": "#2E4052"}

band_min_freq = {'Band 3': 84., 'Band 4': 125., 'Band 5': 163.,
                 'Band 6': 211., 'Band 7': 275., 'Band 8, 9, 10': 373.}

band_max_freq = {'Band 3': 116., 'Band 4': 163., 'Band 5': 211.,
                 'Band 6': 275., 'Band 7': 373., 'Band 8, 9, 10': 950.}
